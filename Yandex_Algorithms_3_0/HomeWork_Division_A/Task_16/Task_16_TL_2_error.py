...
class HeapMin():
    ...
    def remove3(self, value):
        ...
        self.fix_position(self.heap[-1], remove_index)
    ...
    def remove(self, value):
        ...
        while remove_index < size_heap - 2:
            ...
            if index_children_left >= size_heap - 1:
                break
            else:
                children_left = self.heap[index_children_left]

            if index_children_right >= size_heap - 1:
                children_right = None
            else:
            ...
            elif children_left <= self.heap[remove_index] and (children_right is None or children_left <= children_right):
...
def main():
    ...
    lp = LineProfiler()
    lp_wrapper = lp(find_min_by_frame)
    lp_wrapper(n, k, sequence)
    lp.print_stats()
