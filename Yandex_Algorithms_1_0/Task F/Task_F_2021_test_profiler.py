...
@pytest.mark.parametrize(
    "numbers, target_table_variants",
    [
        ([10, 2, 2, 10, ], [(20, 2), (2, 20), (10, 4), (4, 10)]),
        ([5, 7, 3, 2, ], [(9, 5), (5, 9)]),
    ]
)
def test_count_combination_queens(numbers, target_table_variants):
    c, d = calc_size_table(*numbers)
    assert (c, d) in target_table_variants
